    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HousingObjects", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HousingObjectId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Invoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Invoices_HousingObjects_HousingObjectId",
                        column: x => x.HousingObjectId,
                        principalTable: "HousingObjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "OrganizationHousingObjects",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationHousingObjects", x => new { x.OrganisationId, x.HousingObjectId });
                    table.ForeignKey(
                        name: "FK_OrganizationHousingObjects_HousingObjects_HousingObjectId",
                        column: x => x.HousingObjectId,
                        principalTable: "HousingObjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrganizationHousingObjects_Organisations_OrganisationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_HousingObjectId",
                table: "Invoices",
                column: "HousingObjectId");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationHousingObjects_HousingObjectId",
                table: "OrganizationHousingObjects",
                column: "HousingObjectId");
